...
plot(xval+.5,yval+.5,'gd','HandleVisibility','off');
...
while but == 1
    ...
    plot(xval+.5,yval+.5,'ro','HandleVisibility','off');
...
Plan(xval,yval)=0;
 plot(xval+.5,yval+.5,'bo','HandleVisibility','off');
 text(xval+1,yval+.5,'Vehicle')
